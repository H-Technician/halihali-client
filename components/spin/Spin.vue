...
<template>
  <div
    :class="`hui-spin-wrap spin-${size}`"
    :style="`--spin-color: ${color}; --magic-ring-color: ${magicRingColor}; --spin-circle-width: ${spinCircleWidth}; --spin-speed: ${speed}ms;`"
  >
    <div class="hui-spin" v-show="spinning">
      <div class="hui-spin-box">
        <div v-if="indicator === 'dot'" class="hui-loading-dot">
        ...
        <div v-if="indicator === 'spin-dot'" class="spin-wrap-box" :class="{ 'spin-box-rotate': rotate }">
          <div class="hui-spin-dot">
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
          </div>
          <div class="hui-spin-dot spin-rotate" :class="{ 'has-tip': tip }">
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
        ...
        <div v-if="indicator === 'spin-line'" class="spin-wrap-box" :class="{ 'spin-box-rotate': rotate }">
          <div class="hui-spin-line">
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
          </div>
          <div class="hui-spin-line spin-rotate" :class="{ 'has-tip': tip }">
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
            <span class="spin-item"></span>
        ...
        <div v-if="indicator === 'ring-circle'" class="hui-ring-circle">
        ...
        <div v-if="indicator === 'ring-rail'" class="hui-ring-rail">
          <svg class="circle" viewBox="0 0 100 100">
            <path
              :d="circlePath"
        ...
        <div v-if="indicator === 'dynamic-circle'" class="hui-dynamic-circle">
          <svg class="circle" viewBox="0 0 50 50">
            <circle class="path" cx="25" cy="25" r="20" fill="none"></circle>
          </svg>
        </div>
        <div v-if="indicator === 'magic-ring'" class="hui-magic-ring">
