...
<template>
    <div class="hui-radio" :class="{
        ...
        <div v-if="!button" class="hui-radio-wrap" :class="{ 'radio-disabled': disabled || option.disabled }"
        ...
        <template v-else>
            <div tabindex="0" class="hui-radio-button-wrap" :class="{
