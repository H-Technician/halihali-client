<template>
  <div class="hui-tooltip" @mouseenter="onShow" @mouseleave="onHide">
    <div
      ref="tooltipRef"
      class="hui-tooltip-content"
      ...
      @mouseleave="onShow"
    >
      <div class="hui-tooltip" :style="overlayStyle">
        <slot name="tooltip">{{ tooltip }}</slot>
      </div>
      <!-- <div class="hui-tooltip-arrow" v-if="isShowArrow"></div> -->
    </div>
    <div ref="contentRef">
      <slot></slot>
    </div>
