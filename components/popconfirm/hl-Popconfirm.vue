...
interface Props {
  ...
  isshowIcon?: boolean // 是否显示 Icon 图标
...
<template>
  ...
  >
    ...
    >
      <div class="hl-popconfirm" :style="popconfirmStyle">
        <div class="hl-popconfirm-message" v-if="isshowIcon">
          <span class="hl-popconfirm-icon" :class="`icon-${iconType}`" :style="iconStyle">
            <slot name="icon">
              <svg
                v-if="iconType === 'info'"
                class="icon-svg"
          ...
          <div v-if="title" class="popconfirm-title" :class="{ 'title-font-weight': showDesc }" :style="titleStyle">
