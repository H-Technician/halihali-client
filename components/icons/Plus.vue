<template>
    <!-- <svg t="1725796147288" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="4253" width="32" height="32">
        <path
            d="M938.67 554.63l-0.01-85.33-384 0.03-0.03-384-85.33 0.01 0.03 384-384 0.03 0.01 85.33 384-0.03 0.03 384 85.33-0.01-0.03-384z"
            p-id="4254"></path>
    </svg> -->
