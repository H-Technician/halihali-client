<template>
    <div class="home-channel" ref="channelElementRef">
        <!-- 左边 -->
        ...
        <div class="right-channel-container">
            ...
            <div class="channel-items__left">
                <a href="" target="_blank" class="channel-popover-list" v-for="(item, index) in channel" :key="item.title">
                    <Popover :popStyle="channelitem <= index + 1 ? 'padding-top: 4px;':'padding-bottom: 4px;'" 
                        :placement="channelitem <= index + 1 ? 'bottom' : 'top'">
                        <template #reference>
                        ...
                        <template #content v-if="item.isdown">
                            <object>
                                <div class="channel-popover">
                                    <a href="" target="_blank" class="channel-popover-item" v-for="(subItem, index) in item.downlist" :key="subItem.title">
                ...
                <Popover popStyle="padding-top: 4px; left: 0;" @isShowPopover="isShowdown">
                    <template #reference>
                        <div class="channel-link-fixed">
                            <span>展开</span>
                            <IconsArrowDown 
                            class="channel-link-fixed-icon"
                            :style="[{transform:isXiaJiantou ? 'rotate(180deg)' : ''}]" 
                    ...
                    <template #content>
                        <div class="channel-fixed-popover">
                            <a href="" target="_blank" class="channel-fixed-popover-item" v-for="item in channel.slice(isChannelDownNum)" :key="item.id">
                                <span>{{item.title}}</span>
                            </a>
                        </div>
                    </template>
            ...
            <div class="channel-items__right">
                <a href="" target="_blank" class="channel-link__right">
...
const channelElementRef = ref<HTMLElement | null>(null);
