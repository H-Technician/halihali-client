...
function onClickPoint(e: MouseEvent) {
...
<template>
  <div :class="['hui-slider', { disabled: disabled }]" ref="slider" :style="`width: ${totalWidth};`">
    <div class="hui-slider-rail" @click.self="disabled ? () => false : onClickPoint($event)"
    :style="`opacity: ${opacity};`">
    </div>
    <div class="hui-slider-range"
    ...
    <div
      ...
      tabindex="0"
      ref="leftHandle"
      class="hui-slider-handle"
      :class="{ handleTransition: transition }"
      :style="`left: ${left}px; right: auto; transform: translate(-50%, 0);`"
    ...
    >
      <div v-if="tooltip" ref="leftTooltip" class="hui-handle-tooltip">
        {{ leftValue }}
        <div class="hui-arrow"></div>
      </div>
    </div>
    <div
      tabindex="0"
      ...
      class="hui-slider-handle"
      :class="{ handleTransition: transition }"
      :style="`left: ${right}px; right: auto; transform: translate(-50%, 0);`"
      ...
      @mouseleave="MouseLeave"
    >
      <div v-if="tooltip" ref="rightTooltip" class="hui-handle-tooltip">
        {{ rightValue }}
        <div class="hui-arrow"></div>
      </div>
    </div>
