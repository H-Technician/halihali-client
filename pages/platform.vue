<template>
    <Title>创作中心 - 哈哩哈哩弹幕视频网 - ( ゜- ゜)つロ 乾杯~</Title>
    <!-- 顶部加载条 -->
    <LoadingBar ref="loadingBarRef" containerClass="platfrom-loading-bar"
        :to="platformViewRef ? platformViewRef : 'body'" />
    <div class="platform-view" ref="platformViewRef">
        <PlatformHeader />
        <!-- 左侧导航 -->
            ...
            <div class="bar-items">
                <div class="platform-nav-slider-sub-menu__wrap bar-item">
                    <div class="platform-navs-item">
                        <div class="nav-wrap" @click="gotoPage('home')"
                            :style="isActive === 'home' ? 'color: var(--brand_blue); fill: var(--brand_blue);' : ''">
                ...
                <div class="platform-nav-slider-sub-menu__wrap bar-item"
                    :class="isSlideDown === 'uploadManager' ? 'active' : ''">
                    <div class="platform-navs-item">
                        <div class="nav-wrap" @click="gotoPage('uploadManager')"
                            :style="isActive === 'uploadManager' ? 'color: var(--brand_blue); fill: var(--brand_blue);' : ''">
                            <IconsPlatformNeiRongGL class="nav-menu-icon" />
                            <span>内容管理</span>
                            <IconsArrowDownBold class="icon-slide-down"
                                :style="[{ transform: isSlideDown === 'uploadManager' ? 'rotate(180deg)' : 'rotate(0deg)' }]" />
                        </div>
                    </div>
                    <div class="platform-navs-item_slide-down">
                        <div class="nav-wrap-item">
                            <div class="nav-wrap-content" @click="gotoPage('uploadManagerArticle')"
                                :class="isActiveArticle ? 'nav-wrap_active' : ''">
                                <span>稿件管理</span>
                            </div>
                        </div>
                        <div class="nav-wrap-item">
                            <div class="nav-wrap-content" @click="gotoPage('uploadManagerAppeal')"
                                :class="isActiveAppeal ? 'nav-wrap_active' : ''">
                                <span>申诉管理</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="platform-nav-slider-sub-menu__wrap bar-item">
                    <div class="platform-navs-item">
                        <div class="nav-wrap" @click="gotoPage('dataCenter')"
                            :style="isActive === 'dataCenter' ? 'color: var(--brand_blue); fill: var(--brand_blue);' : ''">
                ...
                <div class="platform-nav-slider-sub-menu__wrap bar-item"
                    :class="isSlideDown === 'comment' ? 'active' : ''">
                    <div class="platform-navs-item">
                        <div class="nav-wrap" @click="gotoPage('comment')"
                            :style="isActive === 'comment' ? 'color: var(--brand_blue); fill: var(--brand_blue);' : ''">
                            <IconsPlatformHuDongGL class="nav-menu-icon" />
                            <span>互动管理</span>
                            <IconsArrowDownBold class="icon-slide-down"
                                :style="[{ transform: isSlideDown === 'comment' ? 'rotate(180deg)' : 'rotate(0deg)' }]" />
                        </div>
                    </div>
                    <div class="platform-navs-item_slide-down">
                        <div class="nav-wrap-item">
                            <div class="nav-wrap-content" @click="gotoPage('commentArticle')"
                                :class="isActiveCommentArticle ? 'nav-wrap_active' : ''">
                                <span>评论管理</span>
                            </div>
                        </div>
                        <div class="nav-wrap-item">
                            <div class="nav-wrap-content" @click="gotoPage('commentDanmu')"
                                :class="isActiveCommentDanmu ? 'nav-wrap_actives' : ''">
                                <span>弹幕管理</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="platform-nav-slider-sub-menu__wrap bar-item">
                    <div class="platform-navs-item">
                        <div class="nav-wrap" @click="gotoPage('setting')"
                            :style="isActive === 'setting' ? 'color: var(--brand_blue); fill: var(--brand_blue);' : ''">
...
const platformViewRef = ref<HTMLElement | null>(null);
...
.platform-view {
    ...
    min-width: 1236px;
    // background: #fafafa;
    font-family: "HarmonyOS_Sans_Condensed_Light";
...
@media (min-width: 1280px) and (max-width: 1366.9px) {
    .platform-main .content-body {
        margin: 10px 30px 0;
    }
}
