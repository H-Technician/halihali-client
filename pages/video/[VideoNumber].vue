    ...
    <NuxtLayout name="publiclayout" :isDisplayHeader="isDisplayHeader">
        ...
        <div class="video-container" :class="isWideScreen ? 'wide' : ''">
            <div class="left-container" ref="leftRef">
                ...
                <div id="playerWrap" class="player-wrap":class="isWideScreen ? 'wide-player-wrap' : ''">
                    <!-- <ClientOnly>
                        <VideoplayerPlayer :videoUrl="dashUrl" protocol="dash" :interactionCard="interactionCard"
            ...
            <div class="right-container is-in-large-ab">
                <div class="right-container-inner scroll-sticky">
                        ...
                        <div class="up-info-container">
                            <div class="up-info--left">
                                <div class="up-avatar-wrap">
                                    <a class="up-avatar">
                                        <div class="hl-avatar">
                                            <img src="//io.v.hblog.top/hfs/face/706353e46fe1c390d6d2cb72a704818a.jpg@240w_240h_1c_1s_!web-avatar-nav.webp"
                                                class="hl-avatar-img hl-avatar-face hl-avatar-img-radius">
                                        </div>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="up-detail">
                                        <div class="up-detail-top">
                                            ...
                                            <a href="" target="_blank" class="send-msg">
                                                <i class="iconfont icon-message icon-message van-icon-videodetails_messag"></i>
                                                发消息
                                            </a>
                                        </div>
                    ...
                    <!-- <ClientOnly>
                        <div id="danmukuBox" class="danmaku-box">
                            <VideoplayerDanmakuList />
                        </div>
                    </ClientOnly> -->
...
onMounted(async () => {
    ...
    await player.default.mountPlayer('#playerWrap', dashUrl.value, interactionCard, '#danmukuBox', onChangWebFullScreen, ontoggleWideScreen);
